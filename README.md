...
The site loads Gumroad's overlay script and uses `gumroad-button` links so checkout can open on top of the FixSend page. If the script does not load, the same link still opens the Gumroad checkout page.
